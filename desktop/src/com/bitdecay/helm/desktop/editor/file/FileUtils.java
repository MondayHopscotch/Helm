package com.bitdecay.helm.desktop.editor.file;
...
public class FileUtils {
    ...
    public static String saveLevelToFile(com.bitdecay.helm.world.LevelDefinition levelDef) {
    ...
    public static com.bitdecay.helm.world.LevelDefinition loadLevelFromFile() {
        String asJson = loadFile();
        if (asJson == null) {
            return null;
        } else {
            return JsonUtils.unmarshal(com.bitdecay.helm.world.LevelDefinition.class, asJson);
        }
    }
