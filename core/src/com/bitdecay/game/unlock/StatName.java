...
public enum StatName {
    ...
    DEV_MEDALS(MedalUtils.LevelRating.DEV.medalName() + " Medals", "developerMedalCount", StatType.COUNT, StatDisplayType.ONLY_SHOW_WHEN_PRESENT),
    GOLD_MEDALS(MedalUtils.LevelRating.GOLD.medalName() + " Medals", "goldMedalCount", StatType.COUNT, StatDisplayType.ALWAYS_SHOW),
    SILVER_MEDALS(MedalUtils.LevelRating.SILVER.medalName() + " Medals", "silverMedalCount", StatType.COUNT, StatDisplayType.ALWAYS_SHOW),
    BRONZE_MEDALS(MedalUtils.LevelRating.BRONZE.medalName() + " Medals", "bronzeMedalCount", StatType.COUNT, StatDisplayType.ALWAYS_SHOW),
