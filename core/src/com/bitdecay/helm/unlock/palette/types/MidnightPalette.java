...
public class MidnightPalette extends com.bitdecay.helm.system.render.GamePalette {
    public MidnightPalette() {
        ...
        colors.put(com.bitdecay.helm.unlock.palette.GameColors.LAUNCH_SMOKE, new Color(0xD16666FF));
